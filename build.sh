...
cat base.css core.css grid.css navigation.css menus.css typography.css forms.css tables.css images.css icons.css colors.css effects.css shapes.css events.css mobile.css print.css pages.css utilities.css themes.css variables.css >> $cssdist
